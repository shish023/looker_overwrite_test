- view: bp_brand_approved
  ...
  - measure: total_approved_count
    label: "Total Approved Count"
    type: sum
    sql: ${value}
  ...
  - measure: total_bp_count
    label: "Total BP'ed Count"
    type: number
    sql: ${total_approved_count} + ${bp_brand_rejected.total_rejected_count} + ${bp_brand_need_review.total_need_review_count}
